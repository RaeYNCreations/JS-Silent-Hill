...
public class LyingFigure2Entity extends Monster {
    public LyingFigure2Entity(EntityType<? extends Monster> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 0.95D, false));
