...
/**
 * PaCreakingk2 - Silent Hill enemy variant 2
 * Aggressive melee attacker with high health
 */
public class PaCreakingk2Entity extends Monster {
    public PaCreakingk2Entity(EntityType<? extends Monster> entityType, Level level) {
