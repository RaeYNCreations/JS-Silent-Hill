...
public class LadyFukuroModel extends HumanoidModel<LadyFukuroEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(SilentHillMod.MOD_ID, "lady_fukuro"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bone2 = bone.addOrReplaceChild("bone2", CubeListBuilder.create()
            .texOffs(23, 34).addBox(-3.5F, 14.6993F, -0.9537F, 7.0F, 3.0F, 4.0F, CubeDeformation.NONE), 
        ...
        PartDefinition LeftLeg2 = bone2.addOrReplaceChild("LeftLeg2", CubeListBuilder.create()
            .texOffs(65, 15).addBox(0.2F, 8.699F, -0.9537F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.2F)), 
        ...
        PartDefinition RightLeg2 = bone2.addOrReplaceChild("RightLeg2", CubeListBuilder.create()
            .texOffs(26, 64).addBox(-3.2F, 8.699F, -0.9537F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.2F)), 
        ...
        PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create()
            ...
            .texOffs(41, 37).addBox(-3.1422F, 25.6364F, -3.3558F, 3.0F, 7.0F, 5.0F, new CubeDeformation(-0.4F))
            .texOffs(0, 40).addBox(0.1422F, 25.6364F, -3.3558F, 3.0F, 7.0F, 5.0F, new CubeDeformation(-0.4F))
            .texOffs(53, 65).addBox(-2.0F, 27.1993F, -3.9537F, 5.0F, 6.0F, 1.0F, CubeDeformation.NONE), 
        ...
        PartDefinition RightArm = body.addOrReplaceChild("RightArm", CubeListBuilder.create()
            ...
            .texOffs(66, 50).addBox(-5.7588F, 14.1652F, -1.9537F, 3.0F, 2.0F, 3.0F, new CubeDeformation(-0.4F))
            .texOffs(0, 3).addBox(-3.6197F, 15.2872F, -1.9537F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)), 
        ...
        PartDefinition LeftArm = body.addOrReplaceChild("LeftArm", CubeListBuilder.create()
            ...
            .texOffs(65, 8).addBox(2.7588F, 14.1652F, -1.9537F, 3.0F, 2.0F, 3.0F, new CubeDeformation(-0.4F))
            .texOffs(0, 0).addBox(2.6197F, 15.2872F, -1.9537F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.2F)), 
            PartPose.offsetAndRotation(4.0F, 24.6993F, -0.9537F, 31.23252F * (float)(Math.PI / 180.0F), -16.66577F * (float)(Math.PI / 180.0F), 10.31123F * (float)(Math.PI / 180.0F)));
    
        PartDefinition Booba = body.addOrReplaceChild("Booba", CubeListBuilder.create()
            .texOffs(17, 42).addBox(-3.5F, 22.1946F, -3.3854F, 7.0F, 4.0F, 3.0711F, new CubeDeformation(-0.02F)), 
        ...
        PartDefinition Saia = bone2.addOrReplaceChild("Saia", CubeListBuilder.create()
            .texOffs(22, 10).addBox(-4.5F, 12.1993F, -3.0F, 9.0F, 5.0F, 5.0F, new CubeDeformation(-0.2F)), 
        ...
        PartDefinition Monster = bone.addOrReplaceChild("Monster", CubeListBuilder.create()
            .texOffs(21, 22).addBox(-3.5F, 8.6993F, -0.9537F, 7.0F, 5.0F, 6.0F, CubeDeformation.NONE), 
            PartPose.offset(0.0F, 1.0F, 1.0F));
    
        PartDefinition LeftLeg4 = Monster.addOrReplaceChild("LeftLeg4", CubeListBuilder.create()
            .texOffs(58, 36).addBox(2.2F, 3.699F, 1.0463F, 3.0F, 7.0F, 3.0F, CubeDeformation.NONE), 
        ...
        PartDefinition LeftLeg5 = LeftLeg4.addOrReplaceChild("LeftLeg5", CubeListBuilder.create()
            .texOffs(64, 26).addBox(2.2F, -4.301F, -0.9537F, 3.0F, 2.0F, 3.0F, new CubeDeformation(-0.3F))
        ...
        PartDefinition RightLeg4 = Monster.addOrReplaceChild("RightLeg4", CubeListBuilder.create()
            .texOffs(56, 54).addBox(-5.2F, 3.699F, 1.0463F, 3.0F, 7.0F, 3.0F, CubeDeformation.NONE), 
        ...
        PartDefinition RightLeg5 = RightLeg4.addOrReplaceChild("RightLeg5", CubeListBuilder.create()
            ...
            .texOffs(56, 47).addBox(-5.2F, -4.301F, -0.9537F, 3.0F, 2.0F, 3.0F, new CubeDeformation(-0.3F)), 
        ...
        PartDefinition body2 = Monster.addOrReplaceChild("body2", CubeListBuilder.create()
            ...
            .texOffs(48, 29).addBox(-3.0F, 10.0F, -4.0F, 6.0F, 3.0F, 3.0F, new CubeDeformation(0.2F)), 
    ...
    @Override
    public void setupAnim(LadyFukuroEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float netHeadPitch) {
