...
public class PaCreakingkanotherModel extends HumanoidModel<PaCreakingkanotherEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
        ResourceLocation.fromNamespaceAndPath(SilentHillMod.MOD_ID, "pa_creakingkanother"), "main");

    public PaCreakingkanotherModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        // Add remaining geometry converted from pa_creakingkanother.json
    ...
    @Override
    public void setupAnim(PaCreakingkanotherEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float netHeadPitch) {
