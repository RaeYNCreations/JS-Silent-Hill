...
public class StraightjacketModel extends HumanoidModel<StraightjacketEntity> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition monster = bone.addOrReplaceChild("Monster", CubeListBuilder.create()
            .texOffs(21, 22).addBox(-3.5F, 8.6993F, -0.9537F, 7.0F, 5.0F, 6.0F, CubeDeformation.NONE), PartPose.offset(0.0F, 1.0F, 1.0F));
    
        PartDefinition leftLeg4 = monster.addOrReplaceChild("LeftLeg4", CubeListBuilder.create()
            .texOffs(58, 36).addBox(2.2F, 3.6990F, 1.0463F, 3.0F, 7.0F, 3.0F, CubeDeformation.NONE), 
            PartPose.offsetAndRotation(4.1F, 10.6993F, 3.0463F, -38.12355F , -24.72953F , 2.11598F ));
        ...
        PartDefinition leftLeg5 = leftLeg4.addOrReplaceChild("LeftLeg5", CubeListBuilder.create()
            ...
            PartPose.offsetAndRotation(4.1F, 3.6993F, 1.0463F, 70.0F , 0.0F, 0.0F));
    
        PartDefinition rightLeg4 = monster.addOrReplaceChild("RightLeg4", CubeListBuilder.create()
            .texOffs(56, 54).addBox(-5.2F, 3.6990F, 1.0463F, 3.0F, 7.0F, 3.0F, CubeDeformation.NONE), 
            PartPose.offsetAndRotation(-3.9F, 10.6993F, 3.0463F, -38.12355F , 24.72953F , -2.11598F ));
        ...
        PartDefinition rightLeg5 = rightLeg4.addOrReplaceChild("RightLeg5", CubeListBuilder.create()
            ...
            PartPose.offsetAndRotation(-3.9F, 3.6993F, 1.0463F, 70.0F , 0.0F, 0.0F));
        ...
        PartDefinition body2 = monster.addOrReplaceChild("body2", CubeListBuilder.create()
            ...
            PartPose.offsetAndRotation(0.0F, 11.6993F, -1.9537F, 122.5F , 0.0F, 0.0F));
        ...
        PartDefinition leftear2 = head2.addOrReplaceChild("leftear2", CubeListBuilder.create(), 
            PartPose.offsetAndRotation(5.0F, 22.6993F, -2.9537F, 0.0F, 0.0F, -30.0F ));
        ...
        PartDefinition rightArm2 = body2.addOrReplaceChild("RightArm2", CubeListBuilder.create()
            ...
            PartPose.offsetAndRotation(-4.0F, 16.6993F, -3.9537F, 20.0F , 0.0F, 15.0F ));
        ...
        PartDefinition booba4 = booba3.addOrReplaceChild("Booba4", CubeListBuilder.create(), 
            PartPose.offsetAndRotation(0.0F, 14.6993F, -0.9537F, -2.5F , 0.0F, 0.0F));
